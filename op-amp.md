...
There are several ways in which operational apmplifiers can be wired dpending on the desired function. 
- [[Non-inverting amplifier circuit]]
- Inverting amplifier circuit
- Differential amplifier circuit
- Voltage follower circuit

There are several parameters/terms which need to be understood in its applications:
